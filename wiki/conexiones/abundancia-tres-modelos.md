---
titulo: "Abundancia: tres modelos en tensión"
tipo: conexion
fecha_creacion: 2026-04-18
fecha_actualizacion: 2026-04-18
fuentes: [raw/no-ficcion/abundance_notas_Miguel.md, raw/no-ficcion/less-is-more-notas_Miguel.md, raw/ficcion/los_desposeidos_notas_Miguel.md]
etiquetas: [abundancia, decrecimiento, solarpunk, capacidad-estatal, liberalismo, transformacion-social]
---

# Abundancia: tres modelos en tensión

## Resumen

Página de conexión que cartografía tres concepciones radicalmente distintas de "abundancia" que circulan en las lecturas del grupo. La palabra es la misma; los proyectos políticos que nombra son incompatibles. La tensión entre ellos define en buena medida el debate sobre qué futuro es deseable y posible.
...
Ni más producción ni más austeridad, sino transformación cualitativa de la experiencia. La abundancia no es tener más cosas sino tener más vida: tiempo, relaciones, creatividad, cuerpo, territorio. Este tercer modelo no tiene aún su libro de referencia en la wiki —es más un horizonte implícito en la ficción solarpunk que un programa elaborado.

### La coincidencia más reveladora: el agente ausente
...
[[obras/los_desposeidos|Los Desposeídos]] aporta una perspectiva que los dos libros de no ficción no pueden: muestra qué aspecto tiene la suficiencia vivida durante generaciones. Anarres no es exactamente ninguno de los tres modelos:
...
- Es el más cercano al tercer modelo, pero con el coste afectivo que Le Guin no oculta: la suficiencia puede ser justa sin ser gozosa.
...
- ¿Son los tres modelos realmente incompatibles, o puede haber síntesis? ¿Qué cedería cada uno?
...
- ¿El tercer modelo (abundancia vivida) tiene un programa político o solo un imaginario cultural?
- ¿Qué diría Hickel de Klein/Thompson? ¿Qué diría Le Guin de Hickel?
